      ...
      <form className="form" onSubmit={props.handleSubmit}>
        <div className="font-container">
          ...
          >
            ...
            <option className="font-opensans" value="Open Sans">
              Open Sans
            </option>
            <option className="font-poppins" value="Poppins">
              Poppins
            </option>
            <option className="font-sacramento" value="Sacramento">
              Sacramento
            </option>
            <option className="font-ubuntu" value="Ubunto">
              Ubuntu
            </option>
            <option className="font-hanaleifill" value="Hanalei Fill">
              Hanalei Fill
            </option>
            <option className="font-luckiestguy" value="Luckiest Guy">
              Luckiest Guy
            </option>
            <option className="font-montserrat" value="Montserrat">
              Montserrat
            </option>
            <option className="font-pacifico" value="Pacifico">
              Pacifico
            </option>
          </select>
        </div>
