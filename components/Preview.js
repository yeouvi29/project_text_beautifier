...
function Preview (props) {
    ...
    const [backgroundColor, setBackgroundColor] = useState(props.result.backgroundColor)
    ...
    return (
        <div className="preview-container">
            <h2>preview</h2>
            <div className="preview" style={{fontSize: size, fontFamily: font, color: textColor, textShadow: `-2px -2px 0 ${outlineColor}, 2px -2px 0 ${outlineColor}, -2px 2px 0 ${outlineColor}, 2px 2px 0 ${outlineColor}`, backgroundColor: backgroundColor }}>{props.result.textInput}</div> 
        </div>
    )
}
